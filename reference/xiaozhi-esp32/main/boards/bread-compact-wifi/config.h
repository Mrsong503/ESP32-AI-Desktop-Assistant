...
// [Eliya's Mind] 修改：适配实际硬件接线
// INMP441: SCK=GPIO4, WS=GPIO5, SD=GPIO6
// MAX98357A: BCLK=GPIO15, LRC=GPIO16, DIN=GPIO17
...
// 使用独立 I2C 总线 (I2C_NUM_1)，与显示 I2C (GPIO41/42) 分离
#define AHT20_SDA_PIN GPIO_NUM_8
#define AHT20_SCL_PIN GPIO_NUM_9
